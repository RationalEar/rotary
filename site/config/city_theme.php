...
$config['theme']['styles'] = 
	array( 'bootstrap.min', 'style', 'prettyPhoto', 'font-awesome.min', 'layerslider', 'skin', 'lightgallery.min' );
									//, 'simplePagination' 'icon-style' 'auctions' 'jquery-ui-1.10.1.min',
$config['theme']['scripts'] = 
	array( 'bootstrap.min', 'jquery.easing.1.3', 'jquery.quicksand', 'hoverIntent', 'jquery.hoverdir', 'jquery.flexslider', 
		'jquery.prettyPhoto', 'jquery.elastislide', 'jquery.tweet', 'smoothscroll', 'jquery.ui.totop', 'main', 
		'accordion.settings', 'jQuery.BlackAndWhite.min', 'layerslider.kreaturamedia.jquery' );
		// 'auctions', 'jquery.simplePagination','jquery-ui-1.10.1.min',, 'jquery.tweet' 'superfish', 'modernizr.custom.70736'
		//, 'ajax-mail'
