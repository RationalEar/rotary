...
include_once( "./system/shared/libraries/wideimage/WideImage.php");
	$wi = new WideImage();
...
/************* 350x260 **************/	
	...
	if($h>260)
	{
		$t2 = $t1->resize(null, 260, 'inside', 'down');
		$w2 = $t2->getWidth();
		$a = $t1->getTransparentColor();
		$d = (350 - $w2)/2;
		$c = $t2->resizeCanvas( 350, 260, 'center', 'center', $a );
	...
	else
	{
		$d = (260 - $h)/2;
		$a = $t1->getTransparentColor();
		$c = $t1->resizeCanvas( 350, 260, 'center', 'center', $a );
		//$c = $c0->merge($wm50, 'center', 'bottom – 5', 100);
	}
