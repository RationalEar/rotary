...
$config['theme']['styles'] = array( 'molle', 'bootstrap.min', 'icon-style', 'radmin', 'radmin-responsive', 
	'radmin-plugins', 'bootstrap-datetimepicker.min' );

$config['theme']['scripts'] = array('bootstrap.min', 'jquery.cloneposition', 'theme', 'gallery', 'moment', 'bootstrap-datetimepicker.min', 'custom' );
