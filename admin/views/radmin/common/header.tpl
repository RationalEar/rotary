...
<body id="body-<?php if(isset($nav_element)) echo $nav_element; else echo 'index';?>">
	...
	<nav class="navbar navbar-inverse black-gradient" role="navigation">
		...
		<div class="navbar-header">
			...
			<?php echo anchor( 'home', '<span class="rad">Rotary</span> Admin', 'class="navbar-brand brand"' );?>
		</div>
	...
	<div class="col-sm-12 hidden-phone hidden-tablet top-stats">
			<ul class="top-nav-boxes">
				...
				<li>
					<?php echo anchor( 'about/club', '<i class="radmin-bookmark"></i> <span>Avondale</span>' );?>
				</li>
				<li>
					<!-- 
					<div class="notifications-wrapper">
						<div class="notifications"> <strong></strong>
						</div>
					</div> -->
					<?php echo anchor( 'about/rotary', '<i class="radmin-cog"></i> <span>Rotary</span>' );?>
				</li>
				<li>
					<?php echo anchor( 'articles/news', '<i class="radmin-newspaper"></i> <span>News</span>' );?>
				</li>
				<li>
					<?php echo anchor( 'articles/projects', '<i class="radmin-briefcase"></i> <span>Projects</span>' );?>
				</li>
				<li>
					<?php echo anchor( 'articles/gallery', '<i class="radmin-picture"></i> <span>Gallery</span>' );?>
				</li>
				<li>
