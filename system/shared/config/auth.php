...
*/
	...
	*/
	...
	$config['database']['user_group']['columns']['description'] = 'description';
	$config['database']['user_group']['columns']['admin'] = 'admin';
	$config['database']['user_group']['columns']['l'] = 'l';
	$config['database']['user_group']['columns']['r'] = 'r';
	 ...
	 * All columns are required.
	*/ 
	$config['database']['user_privileges']['table'] = 'user_priveleges';
	$config['database']['user_privileges']['columns']['id'] = 'id';
	$config['database']['user_privileges']['columns']['name'] = 'permission';
	$config['database']['user_privileges']['columns']['description'] = 'name';
	 ...
	 * All columns are required.
	*/ 
	$config['database']['user_privilege_users']['table'] = 'permissions';
	$config['database']['user_privilege_users']['columns']['id'] = 'id';
	$config['database']['user_privilege_users']['columns']['user_id'] = 'group';
	$config['database']['user_privilege_users']['columns']['privilege_id'] = 'permission_id';
	...
	*/ 
	...
	$config['database']['custom']['user_profile']['primary_key'] = 'id';
	$config['database']['custom']['user_profile']['foreign_key'] = 'uacc_fk';
	$config['database']['custom']['user_profile']['join'] = 'user_profiles.uacc_fk';
	$config['database']['custom']['user_profile']['custom_columns'] = array(
		'fname','surname','phone', 'alt_phone','bio','photo', 'newsletter', 'occupation', 'company'
	);
	...
	*/
	$config['security']['static_salt'] = 'w3sEyqv0RLt8MdfHF74iABUo';
	...
	*/
	$config['settings']['account_activation_time_limit'] = 60*72;
	...
	*/
	...
	$config['email']['site_title'] = "BIT Technologies";
	
	// Reply email shown as 'from' header on emails.
	$config['email']['reply_email'] = "support@bittechnologyz.com";
	...
	*/
	...
	$config['messages']['delimiters']['status_prefix'] = '<div class="alert alert-info"><a href="#" class="close" data-dismiss="alert">&times;</a>';
	
	// Message End Delimiter
	$config['messages']['delimiters']['status_suffix'] = '</div>';
	
	// Error Start Delimiter
	$config['messages']['delimiters']['error_prefix'] = '<div class="alert alert-error"><a href="#" class="close" data-dismiss="alert">&times;</a>';
