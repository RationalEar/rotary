...
*/
	...
	*/ 
	...
	$config['database']['custom']['user_profile']['custom_columns'] = array(
		'first_name','last_name','phone','newsletter','photo','bio'
	);
	...
	*/ 
	...
	$config['database']['custom']['user_address']['primary_key'] = 'id';
	$config['database']['custom']['user_address']['foreign_key'] = 'uacc_fk';
	$config['database']['custom']['user_address']['join'] = 'user_address.uacc_fk';
	$config['database']['custom']['user_address']['custom_columns'] = array(
		'alias','recipient','phone','company','address_01','address_02','city','county',
		'post_code','country'
	);
	...
	*/ 
	$config['database']['settings']['search_user_cols'] = array('uacc_email', 'first_name', 'last_name');
	...
	*/ 
	$config['sessions']['name'] = 'zYaVs07LiknD';
	...
	*/
	$config['sessions']['login_session_token'] = 'cD3Gr4QKbCmaIt'; 
	...
	*/
	...
	$config['cookies']['remember_series'] = 'VhOCJgbxSUDTIGsw';
	$config['cookies']['remember_token'] = 'Crhi7Ggx4DpVe9cU';
	...
	*/
	$config['cookies']['login_session_token'] = 'SeOjioTC0lWYsq';
	...
	*/
	$config['security']['static_salt'] = 'h6%J+uTLc{!-49dx';
	...
	*/
	$config['security']['login_attempt_limit'] = 30;
